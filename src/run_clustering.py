...
def run_clustering():
    ...
    evaluator.evaluate(X, labels_kmeans_lib, "K-Means Library")
    ...
    evaluator.evaluate(X, labels_kmeans_custom, "K-Means Custom")
    visualizer.plot_clusters(
    ...
    evaluator.evaluate(X, labels_dbscan, "DBSCAN")
    visualizer.plot_clusters(
